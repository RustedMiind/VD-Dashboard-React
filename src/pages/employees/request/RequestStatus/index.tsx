...
function RequestStatus(props: PropsType) {
  return (
          ...
          <TableBody>
            {props.request?.checkedSteps?.map((step) => {
              ...
              return (
                <TableRow key={step.id}>
                  ...
                  <TableCell>{formatDate(props.request?.created_at)}</TableCell>
                  <TableCell>
            ...
            {props.request?.nextStep && (
              <TableRow>
                ...
                <TableCell>{formatDate(props.request?.created_at)}</TableCell>
                <TableCell></TableCell>
                <TableCell>{props.request.nextStep.departmentName}</TableCell>
