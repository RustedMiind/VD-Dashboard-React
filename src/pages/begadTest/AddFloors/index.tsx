import {
  ...
  function AddFloors({ open, setOpen }: propsType) {
    return (
      <Dialog
        open={open}
        fullWidth
        ...
        <DialogContent sx={{bgcolor:"Background"}}>
          <Paper sx={{padding: 2, my:2}}>
            <Grid container spacing={2} component="form">
              <Grid item md={12}>
                <Stack>
                  <Typography fontSize={14} component={"label"}>عدد الأدوار </Typography>
                  <TextField
                    type="text"
                    size="small"
              ...
              <Grid item md={12}>
                <Stack>
                  <Typography fontSize={14} component={"label"}>العمق </Typography>
                  <TextField
                    type="text"
                    size="small"
                    placeholder={"العمق "}
              ...
              <Grid item md={12}>
                <Stack>
                  <Typography fontSize={14} component={"label"}>الحد الأدنى</Typography>
                  <TextField
                    type="text"
                    size="small"
